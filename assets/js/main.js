...
//education
const educationData = document.getElementsByClassName('education__data')
const educationHeader = document.querySelectorAll('.education__header')

function toggleEducation(){
    let itemClass = this.parentNode.className

    for(i = 0; i < educationData.length; i++){
        educationData[i].className = 'education__data education__close'
    }
...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'uil-brightness' : 'uil-cloud-moon'
